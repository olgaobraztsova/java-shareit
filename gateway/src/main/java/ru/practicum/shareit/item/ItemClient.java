...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getUserItems(long ownerId, long from, long size) {
    ...
    public ResponseEntity<Object> findItems(long userId, String text, long from, long size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
